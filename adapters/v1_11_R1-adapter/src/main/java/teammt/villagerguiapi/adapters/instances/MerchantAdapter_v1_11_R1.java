...
public class MerchantAdapter_v1_11_R1 extends BaseAdapter implements IMerchant {

	public MerchantAdapter_v1_11_R1(VillagerInventory toAdapt) {
		super(toAdapt);
	}
	...
	@Override
	public void a(net.minecraft.server.v1_11_R1.ItemStack arg0) {
	...
	public MerchantRecipeList getOffers(EntityHuman arg0) {
		...
		for (VillagerTrade trd : toAdapt.getTrades()) {
			...
			net.minecraft.server.v1_11_R1.ItemStack itm1 = CraftItemStack.asNMSCopy(trd.getItemOne());
			net.minecraft.server.v1_11_R1.ItemStack itm2 = null;
			net.minecraft.server.v1_11_R1.ItemStack result = CraftItemStack.asNMSCopy(trd.getResult());
